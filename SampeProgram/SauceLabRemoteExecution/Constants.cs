...
namespace SauceLabRemoteExecution
{
    class Constants
    {
        ...
        internal static string sauceUser = Saucelab.SAUCE_USERNAME;
        internal static string sauceKey = Saucelab.SAUCE_ACCESS_KEY;
        internal static string tunnelId = Saucelab.TUNNEL_IDENTIFIER;
        internal static string seleniumRelayPort = Saucelab.SELENIUM_PORT;
        internal static string buildTag = Saucelab.BUILD_TAG;
        internal static string seleniumRelayHost = Saucelab.SELENIUM_HOST;
    }
}
